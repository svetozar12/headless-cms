...
// @Success      200  {object} contentTypeModel.ContentModel
// @Router       /v1/contentModel/{id} [get]
func getContentModelById(c *fiber.Ctx) error {
	var contentModel contentTypeModel.ContentModel
	id := c.Params("id")
...
// @Accept       json
// @Success      200  {object} models.PaginationModel[[]contentTypeModel.ContentModel]
// @Router       /v1/contentModel [get]
func getContentModel(c *fiber.Ctx) error {
	var contentModels []contentTypeModel.ContentModel
	var total int64
	...
	return c.Status(fiber.StatusOK).JSON(models.PaginationModel[[]contentTypeModel.ContentModel]{Pagination: models.Pagination{Total: total, Offset: page, Limit: limit}, Data: contentModels})
}
...
// @Tags         contentModel
// @Accept       json
// @Param request body contentTypeModel.Body true "query params""
// @Success      201  {object} contentTypeModel.ContentModel
// @Router       /v1/contentModel [post]
func createContentModel(c *fiber.Ctx) error {
	contentModel := new(contentTypeModel.ContentModel)
